defmodule ReduxTest do
  ...
  setup do
    ...
    {:ok, agent_store: agent_store, gen_store: gen_store, process_store: process_store}
  end
  ...
  test "process subscribers gets notified and unsubscribed",
    ...
    unsubscribe =
      UsingProcess.subscribe(process_store, fn store ->
  ...
  test "gen subscribers gets notified and unsubscribed",
    ...
    unsubscribe =
      UsingGenServer.subscribe(gen_store, fn store ->
  ...
  test "agent subscribers gets notified and unsubscribed",
    ...
    unsubscribe =
      UsingAgent.subscribe(agent_store, fn store ->
